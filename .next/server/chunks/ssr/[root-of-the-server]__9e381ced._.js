...
function DocumentLink({ documentId }) {
    const handleDownload = async ()=>{
        try {
            const { blob, filename } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$Api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].getDocumentFile(documentId);
