...
const api = {
    ...
    renameConversation: async (conversationId, newTitle)=>{
        ...
        return fetchWithToken("".concat(API_BASE_URL, "/api/chat/conversations/").concat(conversationId, "/rename"), {
            method: "PUT",
            headers: {
                "Content-Type": "application/json"
            },
    ...
    uploadTemplate: async (file)=>{
        ...
        const formData = new FormData();
        formData.append("file", file);
        return fetchWithToken("".concat(API_BASE_URL, "/api/templates/upload"), {
            method: "POST",
            body: formData
        });
    },
    /** ===================== DOCUMENTO + TEMPLATE ===================== */ generateDocument: async (param)=>{
        let { template_id, document_id, prompt } = param;
        if (!template_id || !document_id) throw new Error("Template e documento são obrigatórios.");
        return fetchWithToken("".concat(API_BASE_URL, "/api/documents/generate"), {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
function DocumentLink(param) {
    let { documentId, onRemove } = param;
    if (!documentId) return null;
    const handleDownload = async ()=>{
        try {
            const blob = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$Api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].downloadFile(documentId);
            const url = window.URL.createObjectURL(blob);
            const a = document.createElement("a");
            a.href = url;
            a.download = "documento_".concat(documentId, ".pdf");
...
function AddFileModal(param) {
    ...
    const [promptText, setPromptText] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const handleGenerateDocument = async ()=>{
        ...
        try {
            ...
            if (selectedFile) {
                var _uploadResponse_document;
                setIsUploading(true);
                const uploadResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$Api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].uploadDocument(selectedFile);
                inputDocumentId = uploadResponse.file_id || (uploadResponse === null || uploadResponse === void 0 ? void 0 : (_uploadResponse_document = uploadResponse.document) === null || _uploadResponse_document === void 0 ? void 0 : _uploadResponse_document._id);
                if (!inputDocumentId) {
            ...
            const generateData = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$Api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].generateDocument(selectedTemplateId, inputDocumentId, promptText.trim());
            ...
            const blob = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$Api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].downloadFile(generatedFileId);
            const url = window.URL.createObjectURL(blob);
            const a = document.createElement('a');
            a.href = url;
            const templateName = ((_templates_find = templates.find((t)=>t.id === selectedTemplateId)) === null || _templates_find === void 0 ? void 0 : _templates_find.nome) || selectedTemplateId;
            a.download = "Documento_Gerado_".concat(templateName.replace(/\s/g, '_'), ".docx");
            document.body.appendChild(a);
            a.click();
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                    ...
                                    children: templates.length > 0 ? templates.map((t)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                            value: t.id,
                                            children: t.nome
                                        }, t.id, false, {
                                            fileName: "[project]/src/components/AddFileModal.js",
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                            className: "file-upload-label ".concat(isProcessing ? "disabled" : ""),
                            htmlFor: "file-upload",
                            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        children: isUploading ? "Enviando Arquivo..." : isGenerating ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$icons$2f$md$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MdGeneratingTokens"], {
...
_s(AddFileModal, "jVq3919zYjMGzsvsN2VFNgNNUG0=");
_c = AddFileModal;
var _c;
...
function InputChat(param) {
    let { activeConversation, onOpenAddFileModal, onMessageSent, attachedDocumentId, setAttachedDocumentId } = param;
    _s();
    ...
    const attachedFileName = attachedDocumentId ? "Arquivo ".concat(attachedDocumentId.substring(0, 6), "...") : '';
    ...
    const sendMessage = async ()=>{
        ...
        try {
            ...
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$Api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].sendMessage(userPrompt, conversationId, attachedDocumentId);
            handleRemoveAttachment(); // Remove o anexo após o envio (para que o próximo não o use)
            // 3. Resposta do bot
            onMessageSent === null || onMessageSent === void 0 ? void 0 : onMessageSent({
                role: "bot",
                content: (data === null || data === void 0 ? void 0 : data.message_content) || (data === null || data === void 0 ? void 0 : data.content) || (data === null || data === void 0 ? void 0 : data.mensagem) || "Resposta da IA não recebida.",
                id: crypto.randomUUID(),
                ...
                "ChatPage.useEffect.load": async ()=>{
                    try {
                        ...
                        const [convData, userData, templateData] = await Promise.all([
                            ...
                            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$Api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].getTemplates()
                        ]);
        ...
        "ChatPage.useEffect": ()=>{
            ...
            setConversations({
                "ChatPage.useEffect": (prev)=>prev.map({
                        "ChatPage.useEffect": (conv)=>conv._id === activeConversation._id ? {
                                ...conv,
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: messages.map((msg)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "message-bubble ".concat(msg.role === "user" ? "user" : "bot"),
                                children: [
                                    msg.content,
...
_s(ChatPage, "bN2VqeYPP2w86zc++8QaZcCWr1g=");
_c = ChatPage;
var _c;
...
//# sourceMappingURL=src_80b9dc37._.js.map